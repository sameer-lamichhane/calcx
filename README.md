...
A Flutter app that appears to be a normal calculator but contains a hidden chat system powered by Firebase Authentication and Firestore.
...
- No push notifications are implemented (as per requirements)
